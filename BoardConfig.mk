...
# standard recovery fstab setting for LineageOS
#TARGET_RECOVERY_FSTAB := $(DEVICE_PATH)/recovery/recovery.fstab

# replace (autogenerated) recovery.fstab with manual created
PRODUCT_COPY_FILES +=  \
	$(DEVICE_PATH)/twrp.fstab.oreo:recovery/root/etc/twrp.fstab
